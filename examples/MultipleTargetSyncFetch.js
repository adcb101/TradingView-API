...
(async () => {
  ...
  // const SqliteDB  = require('./DbHelper').SqliteDB;
  ...
  /// create table.
  const createtargetTableSql = `create table if not exists targets(target TEXT, time TEXT, trend TEXT,close_ema55 BLOB,close_ema144 BLOB,
    close_ema288 BLOB,close_ema576 BLOB,low_ema55 BLOB ,low_ema144 BLOB,low_ema288 BLOB,low_ema576 BLOB,high_ema55 BLOB,high_ema144,high_ema288 ,high_ema576  BLOB );`;
  //  const createLabelTableSql = 'create table if not exists labels(level INTEGER, longitude REAL, latitude REAL, content BLOB);';
  // db.createTable(createtargetTableSql);
  ...
  (target, time, trend,close_ema55,close_ema144,close_ema288,close_ema576,low_ema55,low_ema144,low_ema288,low_ema576,high_ema55,high_ema144,high_ema288,high_ema576) 
  values(?, ?, ?,?, ?, ?,?, ?, ?,?, ?, ?,?, ?, ?)`;
  db.serialize(() => {
